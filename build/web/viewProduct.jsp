<%-- 
    ...
    Created on : Feb 9, 2022, 10:24:20 AM
    Author     : student07
--%>
        ...
        <section class="form my-4 mx-5">
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div style="align-items: center" class="col-lg-7 px-5 pt-5">
                        <h1 class="font-weight-bold py-3"><%=product.getName()%></h1>
                        <form method="get" action="http://localhost:8080/TeamSuccessV1/OrderController">
                            ...
                            <h6>Ingredients</h6>
                            <p><%=product.getIngredients()%></p><br>

                            <h6>Allergies</h6>
                            <p><%=product.getAllergies()%></p><br>

                            <h6>Dietary</h6>
                            <p><%=product.getDietary()%></p><br>

                            <h6>Price</h6>
                            <p>R <%=product.getPrice()%></p><br>

                            <label for="updateC"><h6>Quantity</h6></label>

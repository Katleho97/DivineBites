<%-- 
    Document   : login
    Created on : Jan 17, 2022, 10:26:28 AM
    Author     : student07
--%>
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-7 px-5 pt-5">
                        ...
                        <!-- <form name="login" method="get" action="http://192.168.128.24:8080/TeamSuccessV1/TeamSuccessControl">-->
                        <form name="login" method="get" action="http://localhost:8080/TeamSuccessV1/TeamSuccessControl">
                            ...
                            <div class="form-row">
                                <div class="col-lg-7">
                                    <button type="submit" class="btnLogin mt-3 mb-5">Login</button>
                                </div>
                            </div>
